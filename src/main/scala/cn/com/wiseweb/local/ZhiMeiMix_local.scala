...
object ZhiMeiMix_local{
  ...
  def main(args: Array[String]): Unit = {
    ...
    askConf.set(TableOutputFormat.OUTPUT_TABLE, "test")
    ...
    paperConf.set(TableOutputFormat.OUTPUT_TABLE, "test2")
    ...
    blogConf.set(TableOutputFormat.OUTPUT_TABLE, "test3")

    // Create context with 5 second batch interval
    val sparkConf = new SparkConf().setAppName("zhimeimix_local")
