...
object YxSyhctMix{
  ...
  def main(args: Array[String]): Unit = {
    ...
    yxConf.set(TableOutputFormat.OUTPUT_TABLE, "yixing")
    ...
    syConf.set(TableOutputFormat.OUTPUT_TABLE, "homepage_hct")

    // Create context with 5 second batch interval
    val sparkConf = new SparkConf().setAppName("yxsyhct_mix")
